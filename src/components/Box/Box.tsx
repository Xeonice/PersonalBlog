...
const Element = styled.div<ElementProps>`
  ...
  ${(props) => (props.fontSize
    ...
    : undefined)}
  ${(props) => (props.fontWeight ? `font-weight: ${props.theme.fontWeight[props.fontWeight]};` : undefined)}
  ${(props) => (props.lineHeight ? `line-Height: ${props.lineHeight};` : undefined)}
  ${(props) => (props.textColor
    ? `color: ${props.theme.colors[props.textColor][props.textTint]};`
    : undefined)}
  display: ${(props) => (props.displayElement ? `${props.displayElement};` : undefined)};
...
const Box: React.FunctionComponent<BoxProps<string>> = function ({
  alignItems,
